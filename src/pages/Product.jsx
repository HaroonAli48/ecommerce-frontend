      ...
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1">
            ...
            <div className="sm:flex grid grid-cols-3 gap-2">
              {productData.sizes.map((item, index) => (
                <button
                  ...
                  className={`border sm:px-4 py-2 px-1 bg-gray-100 ${
          ...
          <button
            ...
            className="bg-gray-400 text-black px-3 py-3 text-sm active:bg-gray-200 ml-3"
          >
            BUY NOW
          </button>
      ...
      <div className="mt-2">
        <div className="flex">
          <p
            ...
            className={`border px-5 py-3 cursor-pointer text-sm${
              toggle === "description"
          ...
          <p
            ...
            className={`border px-5 py-3 text-sm cursor-pointer ${
              toggle === "review" ? "text-gray-900 font-bold" : "text-gray-600"
            }`}
          >
            Reviews ({a})
          </p>
              ...
              <div className="mb-3 relative">
                ...
                <div className="grid grid-cols-[3fr_1fr] max-w-[100%] ">
                  <input
                    ...
                    value={review}
                    className="border outline-black text-sm text-gray-700 p-2"
                  />
                  <button
                    onClick={() => {
                    ...
                    disabled={submit}
                    className="bg-black relative right-0 content-center text-white px-1 py-2 ml-3 text-center sm:w-[60%] text-sm active:bg-gray-700"
                  >
