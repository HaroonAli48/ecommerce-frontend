    ...
    <div className='border-t-2 pt10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className="mt-2">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fugiat asperiores quae architecto sequi? Temporibus a ab quo accusamus tempore adipisci eveniet provident iste, libero autem, omnis voluptates illo velit ipsam?</p>
          <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Provident sint tempora totam odit suscipit veritatis odio vero a temporibus sed, quod ut repellat nam illo corrupti iusto magnam nihil? Laboriosam.</p>
        </div>
      </div>
